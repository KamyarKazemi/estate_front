...
export function PersonalInfoStep({ values, setValues, isValid, loading, skeletonLoading = false, onSubmit }: PersonalInfoStepProps) {
  ...
  if (skeletonLoading) return <PersonalInfoStepSkeleton />;
  ...
  return (
    ...
    >
      ...
      <motion.div variants={fieldVariants}>
        <label className="mb-2 block text-sm font-medium text-white">نام خانوادگی</label>
        <motion.input
          type="text"
      ...
      <motion.div variants={fieldVariants}>
        <label className="mb-2 block text-sm font-medium text-white">ایمیل</label>
        <motion.input
          type="email"
          value={values.email}
      ...
      <motion.div variants={fieldVariants}>
        <label className="mb-2 block text-sm font-medium text-white">رمز عبور</label>
      ...
      <motion.div variants={fieldVariants}>
        <label className="mb-2 block text-sm font-medium text-white">تکرار رمز عبور</label>
        <div className="relative">
          <motion.input
      ...
      <motion.button
        ...
        "
      >
        {loading ? (<><Spinner /><span>در حال تکمیل ثبت‌نام...</span></>) : "تکمیل ثبت‌نام"}
      </motion.button>
    </motion.form>
  );
}
